...
@Config
@Autonomous(name = "RedBackNewTest", group = "Autonomous")
public class RedBackNewTest extends LinearOpMode {
    public class Shooters {
        ...
        public class Telem implements Action {
            private final Action sleep = new SleepAction(16.0);
            @Override
